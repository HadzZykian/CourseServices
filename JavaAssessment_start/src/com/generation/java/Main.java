...
public class Main
{
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        HashMap<String, EnrolledCourse> enrolledCourses = studentService.enrolledCourses(student);
        // For Loop to loop through getEnrolledCourse and print out
        for (EnrolledCourse enrolledCourse : enrolledCourses.values()) {
            System.out.println("course:Course{code= " + enrolledCourse.getModule().getCode() + ", name= " + enrolledCourse.getModule().getName() + ", credits= " + enrolledCourse.getCredits() + ", module=Module{name" + enrolledCourse.getName() + "}}");
        }
        ...
        System.out.println("Enter course grade for");
    ...
    private static void showPassedCourses(StudentService studentService, Scanner scanner )
    {
        ...
        //1) Get the student id from scanner
        //2) call method(s) from studentService to return just the passed courses
    }
}
